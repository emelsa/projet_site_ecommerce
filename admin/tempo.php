...
require_once("../inc/init.inc.php");
    ...
    if(isset($produit_actuel["ID_produit"])) echo $produit_actuel['ID_produit']; echo '">
        ...
        <input type="text" id="titre" name="titre" placeholder="le titre de produit"'; if(isset($produit_actuel['titre'])) echo $produit_actuel['titre']; echo'"><br><br>

        <label for="description">description</label>
        <textarea id="description" name="description" placeholder="la description de produit" '; if(isset($produit_actuel['description'])) echo $produit_actuel['description']; echo'"></textarea><br><br>

        <label for="couleur">couleur</label>
        <input type="text" id="couleur" name="couleur" placeholder="la couleur de produit" '; if(isset($produit_actuel['couleur'])) echo $produit_actuel['couleur']; echo'"><br><br>
        ...
        <input type="radio" name="public" value="F"'; if(isset($produit_actuel) && $produit_actuel['public'] == 'M') echo ' checked '; echo '>Femme<br><br>

        <label for="photo">photo</label>
        <input type="file" id="photo" name="photo"><br><br>';
        if(isset($produit_actuel)){
            echo '<i>Vous pouvez oploader une nouvelle photo si vous souhaitez la changer</i><br>';
        ...
        <input type="text" id="prix" name="prix" placeholder="le prix de produit" value="'; if(isset($produit_actuel['prix'])) echo $produit_actuel['prix']; echo'"><br><br>

        <label for="stock">stock</label>
        <input type="text" id="stock" name="stock" placeholder="le stock de produit" value="'; if(isset($produit_actuel['stock'])) echo $produit_actuel['stock']; echo'"><br><br>
